...
export const data = new SlashCommandBuilder().setName("ping").setDescription(t("commands.ping.description", { defaultValue: "Check bot latency" })).setNameLocalizations(createLocalizationMap(commandNames.ping)).setDescriptionLocalizations(createLocalizationMap(commandDescriptions.ping));
