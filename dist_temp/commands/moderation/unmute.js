...
export const data = new SlashCommandBuilder().setName("unmute").setDescription(t("commands.moderation.subcommands.unmute.description")).addUserOption(
  (option) => option.setName("user").setDescription(t("commands.moderation.subcommands.unmute.options.user")).setRequired(true)
).addStringOption(
  (option) => option.setName("reason").setDescription(t("commands.moderation.subcommands.unmute.options.reason")).setRequired(false).setMaxLength(500)
...
export async function execute(interaction) {
  ...
  try {
    ...
    const embed = new EmbedBuilder().setColor(3066993).setTitle(t("commands.moderation.subcommands.unmute.success.title")).setDescription(
