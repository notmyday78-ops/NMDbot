...
export const data = new SlashCommandBuilder().setName("purge").setDescription(t("commands.moderation.subcommands.purge.description")).addIntegerOption(
  (option) => option.setName("amount").setDescription(t("commands.moderation.subcommands.purge.options.amount")).setRequired(true).setMinValue(2).setMaxValue(100)
).addUserOption(
  (option) => option.setName("user").setDescription(t("commands.moderation.subcommands.purge.options.user")).setRequired(false)
).addChannelOption(
  (option) => option.setName("channel").setDescription(t("commands.moderation.subcommands.purge.options.channel")).addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement)
...
export async function execute(interaction) {
  ...
  try {
    ...
    const embed = new EmbedBuilder().setColor(5793266).setTitle(t("commands.moderation.subcommands.purge.success.title")).setDescription(
