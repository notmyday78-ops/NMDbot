...
export const data = new SlashCommandBuilder().setName("unlock").setDescription(t("commands.moderation.subcommands.unlock.description")).addChannelOption(
  (option) => option.setName("channel").setDescription(t("commands.moderation.subcommands.unlock.options.channel")).addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement)
).addStringOption(
  (option) => option.setName("reason").setDescription(t("commands.moderation.subcommands.unlock.options.reason")).setRequired(false).setMaxLength(500)
...
export async function execute(interaction) {
  ...
  try {
    ...
    const embed = new EmbedBuilder().setColor(3066993).setTitle(t("commands.moderation.subcommands.unlock.success.title")).setDescription(
