...
export const data = new SlashCommandBuilder().setName("slowmode").setDescription(t("commands.moderation.subcommands.slowmode.description")).addIntegerOption(
  (option) => option.setName("duration").setDescription(t("commands.moderation.subcommands.slowmode.options.duration")).setRequired(true).setMinValue(0).setMaxValue(21600)
).addChannelOption(
  (option) => option.setName("channel").setDescription(t("commands.moderation.subcommands.slowmode.options.channel")).addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement)
).addStringOption(
  (option) => option.setName("reason").setDescription(t("commands.moderation.subcommands.slowmode.options.reason")).setRequired(false).setMaxLength(500)
...
export async function execute(interaction) {
  ...
  try {
    ...
    const embed = new EmbedBuilder().setColor(3447003).setTitle(t("commands.moderation.subcommands.slowmode.success.title")).setDescription(
      t("commands.moderation.subcommands.slowmode.success.description", {
        channel: channel.toString(),
        duration: duration ? t("commands.moderation.subcommands.slowmode.success.durationValue", {
          seconds: duration
