...
export const data = new SlashCommandBuilder().setName("ban").setDescription(t("commands.moderation.subcommands.ban.description")).addUserOption(
  (option) => option.setName("user").setDescription(t("commands.moderation.subcommands.ban.options.user")).setRequired(true)
).addStringOption(
  (option) => option.setName("reason").setDescription(t("commands.moderation.subcommands.ban.options.reason")).setRequired(false).setMaxLength(500)
).addIntegerOption(
  (option) => option.setName("delete_days").setDescription(t("commands.moderation.subcommands.ban.options.deleteDays")).setRequired(false).setMinValue(0).setMaxValue(7)
...
export async function execute(interaction) {
  ...
  try {
    try {
      const dmEmbed = new EmbedBuilder().setColor(16711680).setTitle(t("commands.moderation.subcommands.ban.dmTitle")).setDescription(
    ...
    const embed = new EmbedBuilder().setColor(16711680).setTitle(t("commands.moderation.subcommands.ban.success.title")).setDescription(
