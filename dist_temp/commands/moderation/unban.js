...
export const data = new SlashCommandBuilder().setName("unban").setDescription(t("commands.moderation.subcommands.unban.description")).addStringOption(
  (option) => option.setName("user_id").setDescription(t("commands.moderation.subcommands.unban.options.userId")).setRequired(true).setMinLength(17).setMaxLength(20)
).addStringOption(
  (option) => option.setName("reason").setDescription(t("commands.moderation.subcommands.unban.options.reason")).setRequired(false).setMaxLength(500)
...
export async function execute(interaction) {
  ...
  try {
    ...
    const embed = new EmbedBuilder().setColor(3066993).setTitle(t("commands.moderation.subcommands.unban.success.title")).setDescription(
