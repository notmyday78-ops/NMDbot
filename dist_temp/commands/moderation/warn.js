...
export const data = new SlashCommandBuilder().setName("warn").setDescription("Manage user warnings").setDescriptionLocalizations(createLocalizationMap(commandDescriptions.warn)).setDefaultMemberPermissions(PermissionFlagsBits.ModerateMembers).addSubcommand(
  (subcommand) => subcommand.setName("create").setDescription("Issue a warning to a user").setDescriptionLocalizations(createLocalizationMap(subcommandDescriptions.warn.create)).addUserOption(
    (option) => option.setName("user").setDescription("The user to warn").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.user)).setRequired(true)
  ).addStringOption(
    (option) => option.setName("title").setDescription("Title of the warning").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.title)).setRequired(true).setMaxLength(255)
  ).addStringOption(
    (option) => option.setName("description").setDescription("Description of the warning").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.description)).setRequired(false).setMaxLength(1e3)
  ).addIntegerOption(
    (option) => option.setName("level").setDescription("Warning level (1-10)").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.level)).setRequired(false).setMinValue(1).setMaxValue(10)
  ).addAttachmentOption(
    (option) => option.setName("proof").setDescription("Proof attachment").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.proof)).setRequired(false)
  )
).addSubcommand(
  (subcommand) => subcommand.setName("edit").setDescription("Edit an existing warning").setDescriptionLocalizations(createLocalizationMap(subcommandDescriptions.warn.edit)).addStringOption(
    (option) => option.setName("warnid").setDescription("The warning ID to edit").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.warnid)).setRequired(true)
  )
).addSubcommand(
  (subcommand) => subcommand.setName("lookup").setDescription("Look up a specific warning").setDescriptionLocalizations(createLocalizationMap(subcommandDescriptions.warn.lookup)).addStringOption(
    (option) => option.setName("warnid").setDescription("The warning ID to look up").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.warnid)).setRequired(true)
  )
).addSubcommand(
  (subcommand) => subcommand.setName("delete").setDescription("Delete a warning by ID").setDescriptionLocalizations(createLocalizationMap(subcommandDescriptions.warn.delete)).addStringOption(
    (option) => option.setName("warnid").setDescription("The warning ID to delete").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.warnid)).setRequired(true)
  )
).addSubcommand(
  (subcommand) => subcommand.setName("view").setDescription("View all warnings for a user").setDescriptionLocalizations(createLocalizationMap(subcommandDescriptions.warn.view)).addUserOption(
    (option) => option.setName("user").setDescription("The user to view warnings for").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.user)).setRequired(true)
  )
).addSubcommand(
  (subcommand) => subcommand.setName("purge").setDescription("Remove all warnings for a user").setDescriptionLocalizations(createLocalizationMap(subcommandDescriptions.warn.purge)).addUserOption(
    (option) => option.setName("user").setDescription("The user whose warnings will be purged").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.user)).setRequired(true)
  )
).addSubcommandGroup(
  (group) => group.setName("automation").setDescription("Manage warning automations").setDescriptionLocalizations(
    createLocalizationMap(subcommandDescriptions.warn.automation.group)
  ).addSubcommand(
    (subcommand) => subcommand.setName("create").setDescription("Create a warning automation").setDescriptionLocalizations(
      createLocalizationMap(subcommandDescriptions.warn.automation.create)
    ).addStringOption(
      (option) => option.setName("trigger_type").setDescription("When this automation should trigger").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.triggerType)).setRequired(true).addChoices(
        {
          name: "Warn Count",
          value: "warn_count",
          name_localizations: {
      ...
      (option) => option.setName("trigger_value").setDescription("Threshold that triggers the automation").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.triggerValue)).setRequired(true).setMinValue(1).setMaxValue(100)
    ).addChannelOption(
      (option) => option.setName("notify_channel").setDescription("Channel that receives automation alerts").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.notifyChannel)).addChannelTypes(ChannelType.GuildText).setRequired(false)
    )
  ).addSubcommand(
    (subcommand) => subcommand.setName("view").setDescription("View all warning automations").setDescriptionLocalizations(
      createLocalizationMap(subcommandDescriptions.warn.automation.view)
    )
  ).addSubcommand(
    (subcommand) => subcommand.setName("delete").setDescription("Delete a warning automation").setDescriptionLocalizations(
      createLocalizationMap(subcommandDescriptions.warn.automation.delete)
    ).addStringOption(
      (option) => option.setName("automationid").setDescription("The automation ID to delete").setDescriptionLocalizations(createLocalizationMap(optionDescriptions.automationid)).setRequired(true)
    )
  )
);
...
async function handleWarnHelp(interaction) {
...
async function handleWarnCreate(interaction) {
  ...
  try {
    ...
    const embed = new EmbedBuilder().setColor(16753920).setTitle(t("commands.warn.subcommands.create.embed.title")).setDescription(t("commands.warn.subcommands.create.success", { user: user.tag })).addFields(
      {
    ...
    try {
      const dmEmbed = new EmbedBuilder().setColor(16753920).setTitle(t("commands.warn.dm.title", { defaultValue: "You have been warned" })).setDescription(
...
async function handleWarnEdit(interaction) {
  ...
  const modal = new ModalBuilder().setCustomId(`warn_edit:${warnId}`).setTitle(t("commands.warn.subcommands.edit.modal.title"));
  const titleInput = new TextInputBuilder().setCustomId("title").setLabel(t("commands.warn.subcommands.edit.modal.titleField")).setStyle(TextInputStyle.Short).setValue(warning.title).setRequired(true).setMaxLength(255);
  const descriptionInput = new TextInputBuilder().setCustomId("description").setLabel(t("commands.warn.subcommands.edit.modal.descriptionField")).setStyle(TextInputStyle.Paragraph).setValue(warning.description || "").setRequired(false).setMaxLength(1e3);
...
async function handleWarnLookup(interaction) {
  await ensureDeferred(interaction);
  const warnId = interaction.options.getString("warnid", true);
  const warning = await warningRepository.getWarningById(warnId);
  if (!warning || warning.guildId !== interaction.guild.id) {
...
async function handleWarnDelete(interaction) {
  ...
  try {
    ...
    const embed = new EmbedBuilder().setColor(15158332).setTitle(t("commands.warn.subcommands.delete.success.title")).setDescription(t("commands.warn.subcommands.delete.success.description", { warnId })).addFields(
      {
...
async function handleWarnView(interaction) {
  await ensureDeferred(interaction);
  const user = interaction.options.getUser("user", true);
  ...
  const embed = new EmbedBuilder().setColor(16753920).setTitle(t("commands.warn.subcommands.view.title", { user: user.tag })).setDescription(
...
async function handleWarnPurge(interaction) {
  await ensureDeferred(interaction);
  ...
  try {
    ...
    const embed = new EmbedBuilder().setColor(15158332).setTitle(
      translateOrFallback(
...
async function handleAutomationCreate(interaction) {
  ...
  ).setLabel(t("commands.warn.subcommands.automation.create.button")).setStyle(ButtonStyle.Primary);
...
async function handleAutomationView(interaction) {
  await ensureDeferred(interaction);
  ...
  const embed = new EmbedBuilder().setColor(39423).setTitle(t("commands.warn.subcommands.automation.view.title")).setTimestamp();
  for (const automation of automations) {
    ...
    const actionsText = automation.actions.map((action) => formatAutomationAction(action)).join(", ");
    const statusText = automation.enabled ? t("common.enabled") : t("common.disabled");
    const lastTriggered = automation.lastTriggeredAt ? `<t:${Math.floor(automation.lastTriggeredAt.getTime() / 1e3)}:R>` : t("common.none");
    const channelText = automation.notifyChannelId ? `<#${automation.notifyChannelId}>` : t("common.none");
    embed.addFields({
...
async function handleAutomationDelete(interaction) {
  await ensureDeferred(interaction);
...
function formatAutomationAction(action) {
  switch (action.type) {
    ...
    case "timeout":
      return action.duration ? t("commands.warn.subcommands.automation.actions.timeoutDuration", {
    ...
    case "mute":
      return action.duration ? t("commands.warn.subcommands.automation.actions.muteDuration", {
...
function formatAutomationDuration(minutes) {
...
async function respondEphemeral(interaction, response) {
  if (!interaction.deferred && !interaction.replied) {
...
async function deleteInitialReply(interaction) {
  try {
    await interaction.deleteReply();
  } catch {
  }
}
function resolveNotifyChannelId(channel) {
  if (!channel) {
    return void 0;
  }
  ...
  if ("isTextBased" in channel && typeof channel.isTextBased === "function") {
    return channel.isTextBased() ? channel.id : void 0;
  }
  return void 0;
}
