...
export const data = new SlashCommandBuilder().setName("work").setDescription(
...
export async function execute(interaction) {
  ...
  try {
    ...
    ).setDescription(result.transaction.description).setColor(3447003).setThumbnail(interaction.user.displayAvatarURL()).addFields(
      {
