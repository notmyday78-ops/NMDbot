...
import { t } from "../../i18n";
export const data = new SlashCommandBuilder().setName("eco").setDescription(t("commands.economy.description", { defaultValue: "Economy system commands" })).setDescriptionLocalizations(createLocalizationMap(commandDescriptions.economy)).addSubcommand(
  (subcommand) => subcommand.setName("balance").setDescription(
    t("commands.economy.subcommands.balance.description", {
      defaultValue: "Check your or another user's balance"
    })
  ).setDescriptionLocalizations(createLocalizationMap(subcommandDescriptions.economy.balance)).addUserOption(
    ...
    ).setDescriptionLocalizations(createLocalizationMap(optionDescriptions.balanceUser)).setRequired(false)
  )
).addSubcommand(
  ...
  (subcommand) => subcommand.setName("work").setDescription(
  ...
  (subcommand) => subcommand.setName("rob").setDescription(
    t("commands.economy.subcommands.rob.description", {
      defaultValue: "Attempt to rob another user"
    })
  ).setDescriptionLocalizations(createLocalizationMap(subcommandDescriptions.economy.rob)).addUserOption(
    (option) => option.setName("user").setDescription(
      t("commands.economy.subcommands.rob.options.user", { defaultValue: "The user to rob" })
    ).setDescriptionLocalizations(createLocalizationMap(optionDescriptions.robUser)).setRequired(true)
  )
).addSubcommandGroup(
  (group) => group.setName("gamble").setDescription(
  ...
  (group) => group.setName("shop").setDescription(
