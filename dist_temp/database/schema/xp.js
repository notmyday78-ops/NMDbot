...
export const xpSettings = pgTable("xp_settings", {
  ...
  ignoredChannels: text("ignored_channels").default("[]").notNull(),
  // JSON array
  ignoredRoles: text("ignored_roles").default("[]").notNull(),
  // JSON array
  noXpChannels: text("no_xp_channels").default("[]").notNull(),
  // JSON array
  doubleXpChannels: text("double_xp_channels").default("[]").notNull(),
  // JSON array
  roleMultipliers: text("role_multipliers").default("{}").notNull(),
  // JSON object
