...
export const ticketPanels = pgTable("ticket_panels", {
  ...
  panelId: varchar("panel_id", { length: 20 }).notNull().unique(),
  // Custom ID for easy reference
...
export const tickets = pgTable("tickets", {
  ...
  reason: text("reason"),
  // Initial reason from modal
  status: varchar("status", { length: 20 }).default("open").notNull(),
  // open, claimed, closed, locked, frozen
  ...
  ratingId: uuid("rating_id").references(() => ticketRatings.id, {
    onDelete: "set null"
  }),
