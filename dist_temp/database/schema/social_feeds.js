...
export const socialFeeds = pgTable(
  "social_feeds",
  {
    ...
    feedType: varchar("feed_type", { length: 20 }).notNull(),
    // 'youtube' or 'rss'
    feedUrl: varchar("feed_url", { length: 500 }).notNull(),
    channelId: varchar("channel_id", { length: 20 }).notNull(),
    mentionRole: varchar("mention_role", { length: 20 }),
    // Role ID to ping
    customMessage: varchar("custom_message", { length: 2e3 }),
    lastEntryId: varchar("last_entry_id", { length: 255 }),
    // to track what was last posted
