...
export async function execute(oldMember, newMember) {
  try {
    ...
    const changes = [];
    const oldNickname = "nickname" in oldMember && oldMember.nickname !== void 0 ? oldMember.nickname : null;
    ...
    const embed = new EmbedBuilder().setColor(5793266).setTitle(t("modLogs.member.update.title")).setDescription(
