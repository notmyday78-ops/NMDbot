...
describe("EngagementService", () => {
  ...
  describe("trackMessageActivity", () => {
    it("should progress active quests for messages", async () => {
      ...
      engagementRepository.getActiveQuests.mockResolvedValue([
        {
          id: "quest1",
          targetType: "messages",
          targetValue: 10,
      ...
      engagementRepository.getUserQuestProgress.mockResolvedValue({
        progress: 9,
        completed: false
      });
      engagementRepository.listAchievements.mockResolvedValue([]);
      engagementRepository.getUserAchievements.mockResolvedValue([]);
  ...
  describe("prestigeUser", () => {
    it("should fail if user level is below threshold", async () => {
      const mockMember = { id: "user123", user: { bot: false } };
      engagementRepository.getUserPrestige.mockResolvedValue({
        userId: "user123",
        guildId: "guild123",
        level: 10,
        prestigeLevel: 0
