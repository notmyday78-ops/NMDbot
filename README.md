...
[Developer](https://semiconstructor.com) · [Report a Bug](https://github.com/semi-constructor/pegasus/issues) · [Dashboard](https://pegasusbot.app)
...
| /socialfeed add <type> <url> <channel> [...] | Manage social feeds (RSS/YouTube) |
| /socialfeed list | List configured social feeds |
| /socialfeed remove <url> | Remove a social feed |
...
| /starboard setup <channel> | Enable and setup starboard channel |
| /starboard disable | Disable starboard |
| /starboard threshold <count> | Set the number of stars required |
| /starboard emoji <emoji> | Set the starboard emoji |
| /starboard info | View current starboard settings |
...
| /trade offer <user> | Initiate a 5-minute trade offer |
| /trade open | Create an open trade (expires in 24h) |
| /trade gift <user> [coins] [item] [qty] | Directly gift coins or items |
| /vote | Vote for Pegasus to get rewards |
...
| /honeypot <channel> | Administrator | Configure a honeypot channel to trap scammers |
...
| /remind <time> <message> | None | Set a reminder (e.g., 10m, 1h, 1d) |
...
Made with ❤️ by [semiconstructor.com](https://semiconstructor.com)

[![Stars](https://img.shields.io/github/stars/semi-constructor/pegasus?style=social)](https://github.com/semi-constructor/pegasus/stargazers)
[![Forks](https://img.shields.io/github/forks/semi-constructor/pegasus?style=social)](https://github.com/semi-constructor/pegasus/network/members)
